...
#
# Purpose: Analyze data (excluding CA)
#
...
# Exclude CA
dat <- filter(dat, first_elig_state!="CA")
...
write_csv(res, paste0("./care-cascade/results/mpr", mpr_limit, "/risk_crude_excludeCA.csv"))
...
write_csv(est, paste0("./care-cascade/results/mpr", mpr_limit, "/risk_wt_excludeCA.csv"))
